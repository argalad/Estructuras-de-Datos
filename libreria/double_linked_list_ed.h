...
//   al nodo cabecera
//
//  Estructuras de Datos. Grupos A y C. Curso 2022/23
...
class double_linked_list_ed {
   protected:
    ...
    struct Nodo {
        ...
        Nodo(T const& elem, Nodo* ant, Nodo* sig)
   ...
   public:
    ...
    void push_front(T const& e) { inserta_elem(e, fantasma, fantasma->sig); }

    // añadir un elemento por el final
    void push_back(T const& e) { inserta_elem(e, fantasma->ant, fantasma); }
    ...
    bool empty() const { return fantasma->sig == fantasma; }
